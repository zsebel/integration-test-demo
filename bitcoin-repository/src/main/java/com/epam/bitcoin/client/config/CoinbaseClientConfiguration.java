...
import com.epam.bitcoin.client.CoinbaseExchangeRatesClient;
import com.epam.bitcoin.client.config.RetryConfiguration.RetryProperties;
import com.epam.bitcoin.client.factory.ReactiveContextFactory;
import com.epam.bitcoin.client.filters.CoinbaseClientErrorHandlingFilter;
import com.epam.bitcoin.logging.filters.WebClientLoggingFilter;
